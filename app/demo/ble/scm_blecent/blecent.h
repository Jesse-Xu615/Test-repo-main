/****************************************************************************
 * apps/examples/scm_blecent/src/blecent.h
 *
...
extern "C"
{
  ...
  #define print_bytes blecent_print_bytes
  #define print_addr blecent_print_addr
  #define print_mbuf blecnt_print_mbuf
  ...
  void blecent_reinit(void);
  void blecent_reset(void);
